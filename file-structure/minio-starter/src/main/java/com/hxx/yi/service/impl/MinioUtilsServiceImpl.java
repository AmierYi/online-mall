...
import com.hxx.yi.config.MinIOConfigProperties;
import com.hxx.yi.config.MinioConfig;
...
@Slf4j
@Component
public class MinioUtilsServiceImpl implements MinioUtilsService {
    ...
    public String getBasisUrl() {
        return minIOConfigProperties.getEndpoint() + SEPARATOR + minIOConfigProperties.getBucketName() + SEPARATOR;
    }

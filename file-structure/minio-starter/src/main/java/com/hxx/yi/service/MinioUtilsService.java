...
public interface MinioUtilsService {
     ...
     * @throws Exception
     */
    List<Item> getAllObjectsByPrefix(String bucketName,
                                     String prefix,
     ...
     */
    ObjectWriteResponse uploadFile(String bucketName, String objectName,
     ...
     */
    ObjectWriteResponse copyFile(String bucketName, String objectName,
